...
const InvestmentCalculator = () => {
  ...
  const handleCalculate = () => {
    // FIX 1: Was "calculateInvestment" (undefined) - corrected to "calculateInvestmentResults"
            ...
            <tbody>
              {results.map((yearData, index) => (
                <tr key={index}>
                  ...
                  {/* FIX 2: Was "interestGainedYear" - corrected to "interest" */}
                  <td>${yearData.interest.toFixed(2)}</td>
                  {/* FIX 2: Was "totalInterestGained" - corrected to "totalInterest" */}
